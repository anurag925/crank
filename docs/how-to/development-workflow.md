...
Generated projects also include `AGENTS.md` and `.agents/skills/crank-project/SKILL.md` so AI coding agents can detect `.crank.yaml`, read enabled features, and use the same system-installed `crank` command you use. See [AI agent support](../explanation/ai-agents.md).
