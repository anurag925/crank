...
// TestE2E_Make_Repository_Tests covers the repository kind on a postgres
...
func TestE2E_Make_SkipMigration_AllFieldTypes(t *testing.T) {
	dir := scaffold(t, "make_skip_migration_all_types", []string{"base", "postgres"})
...
func TestE2E_Make_SkipMigration_HandlerKind(t *testing.T) {
	dir := scaffold(t, "make_skip_mig_handler", []string{"base", "postgres"})
...
func TestE2E_Make_Migration_Idempotent(t *testing.T) {
	dir := scaffold(t, "make_mig_idempotent", []string{"base", "postgres"})
...
// (DB-agnostic, no postgres required).
...
func TestE2E_Make_AllFieldTypes_Validates(t *testing.T) {
	dir := scaffold(t, "make_all_field_types", []string{"base", "postgres"})
...
func TestE2E_Make_Handler_AfterModel(t *testing.T) {
	dir := scaffold(t, "make_h_after_m", []string{"base", "postgres"})
...
// TestE2E_Make_Handler_WiringOnPostgres exercises the wiring on a
// project that has a different feature set (postgres instead of
