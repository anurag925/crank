...
import (
	...
	appuser "myapp/internal/application/user"
	"myapp/internal/domain/user"
	"myapp/internal/model"
)

// userDTO is the input/output DTO for user HTTP endpoints. The HTTP layer
// owns validation tags; the domain aggregate stays tag-free.
type userDTO struct {
...
func (h *UserHandler) List(c echo.Context) error {
	items, err := h.qry.HandleList(c.Request().Context(), appuser.ListUsersQuery{})
	if err != nil {
