...
│   │   └── persistence     # gorm, memory repositories
...
| `crank migrate up` | Apply all pending migrations |
| `crank migrate down --steps 1` | Roll back the last migration |
| `crank make migration <name>` | Generate a new up/down migration pair |
